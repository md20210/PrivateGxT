    ...
    <div className="bg-white rounded-xl shadow-md flex flex-col" style={{ height: 'calc(100vh - 300px)', minHeight: '500px' }}>
      ...
      <div className="p-4 border-b border-slate-200 flex justify-between items-center">
        ...
        <select
          ...
          className="px-3 py-1.5 bg-slate-100 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
        >
